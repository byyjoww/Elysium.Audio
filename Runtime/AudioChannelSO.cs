...
namespace Elysium.Audio
{
    ...
    {
        public UnityAction<AudioCueSO, AudioConfigSO, Vector3> OnAudioCueRequested;

        public void RaiseEvent(AudioCueSO audioCue, AudioConfigSO audioConfiguration, Vector3 positionInSpace)
        {
